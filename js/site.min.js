...
}), $.getJSON("home.json", function(a) {
    var b = a.slides, c = $(".templates .slide"), d = b.map(function(a) {
        var b = c.clone();
        return $(".slide-title", b).text(a.title), $(".thumb", b).css("background-image", "url(" + a.image + ")"), 
        $(".slide-url", b).attr("href", a.url), b;
    });
    $(".home-slider").html(d), $(".home-slider").flickity({
        prevNextButtons: !1,
        contain: !0
    });
});